...
namespace acorn {
    ...
    public:
        ...
        RangeType* int_range_type;
        RangeType* int8_range_type;
        RangeType* int16_range_type;
        RangeType* int32_range_type;
        RangeType* int64_range_type;
        RangeType* uint8_range_type;
        RangeType* uint16_range_type;
        RangeType* uint32_range_type;
        RangeType* uint64_range_type;
        RangeType* isize_range_type;
        RangeType* usize_range_type;
        RangeType* char_range_type;
        RangeType* char16_range_type;
        RangeType* char32_range_type;
        Type* auto_type;
        Type* auto_ptr_type;
