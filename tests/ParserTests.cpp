...
void test_parser() {
    ...
    section("parsing", [&] {
        ...
        test("function parsing", [&] {
            ...
            expect(funcs[1]->parsed_return_type, type_to_string).to_be(context->void_type);
            ...
            expect(funcs[2]->parsed_return_type, type_to_string).to_be(context->void_type);
            ...
            expect(funcs[3]->parsed_return_type, type_to_string).to_be(context->void_type);
